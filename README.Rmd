...
1	Step2_Linear Regression modeling.R	Checking the multicollinearity and Linear regression modeling 
2	Step3_Poisson_NB_Regression modeling.R	Poisson and NB regression modeling
3	Step4_Make the covariates for prediction.R	From all the forecasting covariate datasets, we define the locations for prediction with the smallest observations, and we make the covariate datasets, based on the location information.
4	Step5_Forecasting_LR.R	Forecasting output from linear regression modeling results
5	Step5_Forecasting_Poi.R	Forecasting output from Poisson regression modeling results
6	Step5_Forecasting_NB_Ver1.R	Forecasting output from NB regression modeling results (Ver1)
7	Step5_Forecasting_NB_Ver2.R	Forecasting output from NB regression modeling results (Ver2)
